...
export function StudyTasksPage({
  ...
  return (
    <main className="px-5 pb-28 pt-7 md:grid md:grid-cols-1 md:items-start md:gap-5 md:px-6 md:pb-8 md:pt-6 lg:grid-cols-[230px_minmax(0,1fr)] lg:px-7 xl:grid-cols-[250px_minmax(0,1fr)]">
      ...
      <div className="mb-4 flex gap-2 overflow-x-auto pb-2 hide-scrollbar md:mb-0 lg:sticky lg:top-6 lg:flex-col lg:overflow-visible lg:rounded-[28px] lg:bg-white lg:p-3 lg:shadow-soft">
