...
const items: Array<{ id: MainTab; label: string; icon: typeof Home }> = [
  ...
  { id: "subjects", label: "科目", icon: BookOpenText },
...
export function BottomNav({ activeTab, onTabChange }: BottomNavProps) {
  return (
    <nav className="fixed bottom-3 left-1/2 z-30 w-[92vw] max-w-[366px] -translate-x-1/2 rounded-[30px] border border-white/80 bg-white/95 p-1.5 shadow-[0_18px_42px_rgba(15,23,42,0.18)] backdrop-blur-xl">
